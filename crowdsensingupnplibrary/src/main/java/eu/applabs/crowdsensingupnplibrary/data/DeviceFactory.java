...
public class DeviceFactory {
    ...
    public LocalDevice createDevice(UDN udn) {
        try {
            ...
            LocalService<HeartRateService> heartRateService =
                    new AnnotationLocalServiceBinder().read(HeartRateService.class);

                heartRateService.setManager(
                    new HeartRateServiceManager(heartRateService, HeartRateService.class)
            );
    ...
    private class HeartRateServiceManager extends DefaultServiceManager {

        public HeartRateServiceManager(LocalService service, Class serviceClass) {
