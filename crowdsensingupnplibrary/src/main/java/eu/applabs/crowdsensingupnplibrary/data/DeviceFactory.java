...
public class DeviceFactory {
    ...
    public LocalDevice createHeartRateDataServiceDevice(UDN udn) {
        try {

            DeviceType type = new UDADeviceType("HeartRateDataService", 1);
            ...
            LocalService<HeartRateDataServiceDefinition> heartDataRateService =
                    new AnnotationLocalServiceBinder().read(HeartRateDataServiceDefinition.class);

            heartDataRateService.setManager(
                    new HeartRateDataServiceManager(heartDataRateService, HeartRateDataServiceDefinition.class)
            );

            return new LocalDevice(new DeviceIdentity(udn), type, details, icon, heartDataRateService);
    ...
    public LocalDevice createStartPollServiceDevice(UDN udn) {
        try {

            DeviceType type = new UDADeviceType("StartPollService", 1);
            ...
            LocalService<StartPollServiceDefinition> startPollService =
                    new AnnotationLocalServiceBinder().read(StartPollServiceDefinition.class);

            startPollService.setManager(
                    new StartPollServiceManager(startPollService, StartPollServiceDefinition.class)
            );

            return new LocalDevice(new DeviceIdentity(udn), type, details, icon, startPollService);
    ...
    private class HeartRateDataServiceManager extends DefaultServiceManager {
        public HeartRateDataServiceManager(LocalService service, Class serviceClass) {
            super(service, serviceClass);
        }
    ...
    private class StartPollServiceManager extends DefaultServiceManager {

        public StartPollServiceManager(LocalService service, Class serviceClass) {
            super(service, serviceClass);
        }
