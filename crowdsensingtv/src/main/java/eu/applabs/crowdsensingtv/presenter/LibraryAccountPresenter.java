...
public class LibraryAccountPresenter extends Presenter {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Object item) {
        LibraryAccount libraryAccount = (LibraryAccount) item;

        ImageCardView cardView = (ImageCardView) viewHolder.view;
        cardView.setTitleText(libraryAccount.getName());
        cardView.setMainImage(libraryAccount.getLogo());
