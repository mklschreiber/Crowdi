...
public class FitnessAccountPresenter extends Presenter {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Object item) {
        FitnessAccount fitnessAccount = (FitnessAccount) item;

        ImageCardView cardView = (ImageCardView) viewHolder.view;
        cardView.setTitleText(fitnessAccount.getName());
        cardView.setMainImage(fitnessAccount.getLogo());
